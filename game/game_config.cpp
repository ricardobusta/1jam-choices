...
namespace Jam {
    void GameConfig::Configure(Harpia::Configuration &configuration) {
        ...
        configuration.game.frameRateCap = 100;
        ...
        configuration.input.mappedKeys.insert(
                configuration.input.mappedKeys.end(),
                {SDLK_UP, SDLK_DOWN, SDLK_LEFT, SDLK_RIGHT, SDLK_w, SDLK_a, SDLK_s, SDLK_d, SDLK_SPACE, SDLK_F1});
